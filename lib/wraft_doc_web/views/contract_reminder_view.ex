defmodule WraftDocWeb.Api.V1.ContractReminderView do
  ...
  def render("index.json", %{reminders: reminders}) do
    %{data: render_many(reminders, __MODULE__, "reminder.json", as: :reminder)}
  end
  ...
  def render("show.json", %{reminder: reminder}) do
    %{data: render_one(reminder, __MODULE__, "reminder.json", as: :reminder)}
  end
