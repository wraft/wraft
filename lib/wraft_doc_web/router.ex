  ...
  scope "/api", WraftDocWeb do
    ...
    scope "/v1", Api.V1, as: :v1 do
      ...
      scope "/contents/:id" do
        ...
        post("/vendors/:vendor_id", VendorController, :connect_to_document)
        delete("/vendors/:vendor_id", VendorController, :disconnect_from_document)
      ...
      scope "/clouds/google" do
        pipe_through([WraftDocWeb.GoogleAuthPlug])
        ...
        get("/folders", CloudImportController, :list_gdrive_folders)
        get("/folders/search", CloudImportController, :search_gdrive_folders)
        get("/folder/:folder_id", CloudImportController, :get_gdrive_folder)
        get("/folder/:folder_id/files", CloudImportController, :list_gdrive_folder_files)
      end

      scope "/clouds/dropbox" do
        pipe_through([WraftDocWeb.DropboxAuthPlug])

        get("/files", CloudImportController, :list_dropbox_files)
        get("/file/:file_id", CloudImportController, :get_dropbox_file)
        post("/download", CloudImportController, :download_dropbox_file)
        get("/search", CloudImportController, :search_dropbox_files)
        get("/pdfs", CloudImportController, :list_all_dropbox_pdfs)
        post("/sync_files", CloudImportController, :sync_dropbox_files)
      ...
      scope "/clouds/onedrive" do
        pipe_through([WraftDocWeb.OnedriveAuthPlug])

        get("/files", CloudImportController, :list_onedrive_files)
        get("/file/:file_id", CloudImportController, :get_onedrive_file)
        post("/download", CloudImportController, :download_onedrive_file)
        get("/search", CloudImportController, :search_onedrive_files)
        get("/pdfs", CloudImportController, :list_all_onedrive_pdfs)
        post("/sync_files", CloudImportController, :sync_onedrive_files)
        get("/folders", CloudImportController, :list_onedrive_folders)
