defmodule WraftDoc.Storage.StorageItem do
  ...
  schema "storage_items" do
    ...
    belongs_to(:repository, WraftDoc.Document.Repository)
  ...
  def changeset(storage_item, attrs) do
    storage_item
    |> cast(attrs, [:name, :display_name, :item_type, :path, :path_hash, :depth_level, :materialized_path, :mime_type, :file_extension, :size, :checksum_sha256, :version_number, :is_current_version, :classification_level, :is_deleted, :deleted_at, :sync_source, :external_id, :external_metadata, :last_synced_at, :content_extracted, :thumbnail_generated, :download_count, :last_accessed_at, :metadata, :parent_id, :repository_id, :creator_id, :organisation_id])
