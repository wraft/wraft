defmodule WraftDoc.Documents do
  ...
  * cc - Email cc
  ...
  @doc """
  Main function to get contract chart data with analytics.

  ## Parameters
  - current_user: User context with organization_id
  - params: Query parameters (period, interval, select_by, from, to)

  ## Returns
  - {:ok, list} - List of contract metrics by interval
  - {:error, reason} - Error message for invalid parameters
  """
