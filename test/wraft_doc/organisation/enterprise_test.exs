defmodule WraftDoc.EnterpriseTest do
  ...
  describe "create_vendor_contact/2" do
    test "create vendor contact on valid attributes" do
      ...
      vendor_contact = Enterprise.create_vendor_contact(user, contact_attrs)
    ...
    test "create vendor contact on invalid attrs" do
      ...
      {:error, changeset} = Enterprise.create_vendor_contact(user, @invalid_vendor_contact_attrs)
  ...
  describe "get_vendor_contact/2" do
    test "get vendor contact by id" do
      ...
      retrieved_contact = Enterprise.get_vendor_contact(user, contact.id)
    ...
    test "returns error for invalid id" do
      user = insert(:user_with_organisation)
      result = Enterprise.get_vendor_contact(user, Ecto.UUID.generate())
    ...
    test "returns error for contact from different organisation" do
      ...
      result = Enterprise.get_vendor_contact(user1, contact.id)
      assert result == {:error, :invalid_id}
    end
  end
  ...
  describe "update_vendor_contact/2" do
    test "update vendor contact on valid attrs" do
      ...
      {:ok, updated_contact} =
        Enterprise.update_vendor_contact(contact, @valid_vendor_contact_attrs)
    ...
    test "returns error on invalid attrs" do
      ...
      {:error, changeset} =
        Enterprise.update_vendor_contact(contact, @invalid_vendor_contact_attrs)
  ...
  describe "delete_vendor_contact/1" do
    test "delete vendor contact" do
      ...
      {:ok, deleted_contact} = Enterprise.delete_vendor_contact(contact)
      count_after = VendorContact |> Repo.all() |> length()
  ...
  describe "vendor_contacts_index/3" do
    test "list vendor contacts with pagination" do
      ...
      result = Enterprise.vendor_contacts_index(user, vendor.id, %{page_number: 1})
