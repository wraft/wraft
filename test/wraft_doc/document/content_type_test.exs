defmodule WraftDoc.ContentTypes.ContentTypeTest do
  ...
  describe "changeset/2" do
    ...
    test "all field EXCEPT :description, :color and other autogenerated are required" do
      changeset = ContentType.changeset(%ContentType{}, %{})
      refute changeset.valid?

      required_fields =
        ContentType.__schema__(:fields) --
          [:id, :description, :color, :inserted_at, :updated_at, :organisation_id, :creator_id]
  ...
  describe "update_changeset/2" do
    ...
    test "all field EXCEPT :description, :color, :organisation_id, :creator_id, and other autogenerated are required" do
      content_type = insert(:content_type)
      ...
      required_fields =
        ContentType.__schema__(:fields) --
          [:id, :description, :color, :organisation_id, :creator_id, :inserted_at, :updated_at]
